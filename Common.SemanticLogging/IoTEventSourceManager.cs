...
namespace IoT.Common.Logging
{
    ...
    /// </summary>
    [EventSource(Name = "AppEventSourceManager")]
    public class AppEventSourceManager : EventSource
    {
        ...
        private static Lazy<AppEventSourceManager> Instance = new Lazy<AppEventSourceManager>(() => new AppEventSourceManager());

        public static AppEventSourceManager Log { get { return Instance.Value; } }
