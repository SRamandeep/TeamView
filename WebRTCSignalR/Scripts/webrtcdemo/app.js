...
WebRtcDemo.App = (function (viewModel, connectionManager) {
    var _mediaStream,
        ...
        _connect = function(username, onSuccess, onFailure) {
            ...
            //CUSTOM CODE FIX----START
            //initializing the callbacks as its needs to be done before the start() menthod otherwise client scripts will not call the server methods.
